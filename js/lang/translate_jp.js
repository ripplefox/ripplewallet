...
var translate_jp = {
  ...
  login_desc : 'ウォレットはプライベートキーを使ってアカウントにログインします。プライベートキーはあなたのパソコンの中に保存するため、アカウントはあなたのパソコンと同様に安全です。必ずプライベートキーをバックアップしてください。',
  ...
  buy_offers : '買い注文',
  sell_offers: '売り注文',
  no_bids : '該当ペアは買い注文がありません',
  no_asks : '該当ペアは売り注文がありません',
  sum   : '総額',
  size  : '数量',
  ask_price : '売り気配値',
  bid_price : '買い気配値',
  ...
  base_asset    : '主軸通貨',
  counter_asset : '決済通貨',
  pick_book  : 'ほかの資産と取引するため、以下の取引を選択できます。',
  trade_pair : 'トレードペア',
  pick_trade : '戻る',
  trade_page : '取引画面',
  advanced   : 'アドバンス',
  ...
  passphrase : 'パスフレーズ',
  max_fee     : '最大費用',
  max_fee_desc: 'ネットが渋滞になる場合に許可できる最大費用は。',
  timeout      : 'タイムアウト',
  ...
  ripple : 'リップル',
  ripple_desktop_client : 'リップルデスクトップウォレット',
  wallet_notice1 : 'あなたの資産とウォレットはデジタル暗号化アルゴリズムに保護されます。使用するにはプライベートキーが必要です。',
